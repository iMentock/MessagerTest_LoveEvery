...
class MessagesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Adding gesture to dismiss keyboard
        ...
        viewModel.getAllMessagesData { [weak self] error in
            ...
            if let _ = error {
                DispatchQueue.main.async {
                    ...
                    ErrorHandlers.presentError(withMessage: "There was an error retrieving the messages. Please try again later.", onVC: self!)
    ...
    /**
     Loads all messages filtered by one user from AWS service and updates table view.
        ...
        viewModel.getAllMessagesData(forUser: forUser) { [weak self] error in
            ...
            if let _ = error {
                DispatchQueue.main.async {
                    ...
                    ErrorHandlers.presentError(withMessage: "There was an error getting the messages for user \(forUser). They may not have any :( ", onVC: self!)
...
extension MessagesViewController: UISearchBarDelegate {
    ...
    // Perform search by user if go is tapped
